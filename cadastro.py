...
class Ui_Tela_Cadastro(object):
    def setupUi(self, Tela_Cadastro):
        ...
        self.link_entrar = QLabel("Entrar", self.frame)
        self.link_entrar.setGeometry(230, 60, 71, 16)
        self.link_entrar.setFont(font2)
        self.link_entrar.setStyleSheet("color: rgb(0, 0, 255); text-decoration: underline;")  
        self.link_entrar.setCursor(QCursor(Qt.PointingHandCursor))  
