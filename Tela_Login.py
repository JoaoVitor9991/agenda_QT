...
class Ui_Tela_Login(QWidget):
    ...
    def setupUi(self):
        ...
        self.txt_email.setGeometry(QRect(150, 230, 50, 14))
        ...
        self.txt_senha.setGeometry(QRect(150, 310, 50, 14))
        ...
        # Link Cadastre-se (usando QPushButton para garantir que a cor mude)
